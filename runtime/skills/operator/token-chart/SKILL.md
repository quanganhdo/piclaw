...
- The estimated cost mode uses `provider-model-pricing-reference.ts`, the route-specific `pricing-2026-09-22.json` snapshot (with explicitly dated September 5 fallbacks), and the human-readable note `provider-model-pricing-reference.md`.
