...
|---|---|---|
| Which source/version is selected? | The existing current loop installs published 0.85.1 (`d981de1229ef899957bbe968bc8dcda02a21f477`). Published 0.87.0 (`16787ad5b2dc748047f314ca1bfe7708f30f54f3`) is candidate evidence only until #1377–#1381 complete. Historical dev/#8963 and the pinned planning tip are not active candidates. | Keep Harness disabled. Production Harness selection requires separate approval after candidate migration and complete applicable HC evidence. |
...
| How is writable Session ownership fenced? | 0.85.1 validates public Memory/JSONL ownership and fork cases. The published 0.87.0 candidate adds public streaming-fork conformance, but its Memory/JSONL execution belongs to #1375 and SQLite parity remains incomplete. | #1375 records streaming-fork evidence; host replacement and SQLite authority require separate proof before activation. |
